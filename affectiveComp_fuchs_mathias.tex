...
The form of the hand can also give information about the emotional state of a person. For example open palms could mean pleasure/ openness, closed hands towards the chest could mean a sense of pride and clenched fists could mean anger\cite{beale2008affect,singh2015edbl}.
...
This approach inputs a given image into a two-branched convolutional neural network
Compared to the approach in \autoref{subsec:lieDetectionLAM} no initialisation pose is needed. Hence the features can be extracted instantly and live. Like this we could also analyse the shoulder position like it was done in \cite{barathi2016lie}.
